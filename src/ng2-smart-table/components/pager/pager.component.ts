...
@Component({
    selector: 'ng2-smart-table-pager',
     template: `
        <nav *ngIf="shouldShow()" class="table__pagination">
            <ul class="flex">
                <li class="table__pagination__item"
                    [ngClass]="{disabled: getPage() == 1}">

                    <a href="#" class="table__pagination__link"
                ...
                <li class="table__pagination__item"
                    ...
                    <span class="ng2-smart-page-link page-link"
                        *ngIf="getPage() == page">{{ page }}
                        <span class="sr-only">(current)</span>
                    </span>

                    <a href="#" class="table__pagination__link"
                        (click)="paginate(page)" *ngIf="getPage() != page">
                        {{ page }}
                    </a>
                </li>
